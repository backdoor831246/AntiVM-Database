...
namespace PastebinData {

    // https://pastebin.com/raw/E5pwq7NH - Blacklisted HWIDs/Machine GUIDs
    inline std::vector<std::string> getBlacklistedHwids() {
        return {
    ...
    // https://pastebin.com/raw/Xe5WMsTU - Blacklisted Processes
    inline std::vector<std::string> getBlacklistedProcesses() {
        return {
            "ProcessHacker.exe",
            "httpdebuggerui.exe",
            "wireshark.exe",
    ...
    // https://pastebin.com/raw/ftd50eAq - Blacklisted MAC prefixes
    inline std::vector<std::string> getBlacklistedMacs() {
        return {
            "00:03:47:1a:f1:f1",
            "00:03:47:20:57:7a",
            "00:03:47:5d:92:c5",
    ...
    // https://pastebin.com/raw/jnEaykLU - Blacklisted Hostnames
    inline std::vector<std::string> getBlacklistedHostnames() {
        return {
            "00900BC83803",
            "0CC47AC83803",
            "6C4E733F-C2D9-4",
    ...
    // https://pastebin.com/raw/Vgztru48 - Blacklisted Usernames
    inline std::vector<std::string> getBlacklistedUsernames() {
        return {
            "05h00Gi0",
            "3u2v9m8",
            "43By4",
    ...
    // https://pastebin.com/raw/vrkN6wA1 - Blacklisted GUIDs (profiles)
    inline std::vector<std::string> getBlacklistedProfileGuids() {
        return {
            "cbbb49d6-b7ff-44ca-aba5-8a5e250d4d42",
            "a3d27cfa-1e7a-4ff8-8004-2be13417b6b1",
            "c784477d-3fc3-4206-9876-55a4df3943da",
            "2b5365f1-eebb-4135-b6e1-413aab299fcb",
            "cdbd2082-8cfa-481b-ad9b-fc08276e590d",
            "4508afd3-5f05-491e-b49f-b44024967766",
            "089e621c-1422-4856-a8b1-3f1db208ce9e",
            "15947802-cb9c-478f-af5c-33b1abbd1bfe",
            "5c5926b0-d06a-4688-ade2-325cbb39b4fc",
            "801de7cf-3111-46e2-946b-65e7431dc386",
            "081ab395-5e85-4634-acdb-2dbd4f59a7d0",
            "453b8045-4cab-4c86-866a-4118a8ac4db6",
            "fb31a63b-dc7c-49d2-8f59-4a30a2594045",
            "10797f1d-9613-4832-b1a3-c22fe365b89d",
            "9083fa32-68f2-4dff-a60e-e076f7aeabd3",
            "6c5fe7fc-a9c6-46cd-baea-529d2dedc1df",
            "6a94764b-5e0f-42cf-8947-df4b99cb5c"
        };
    }

    // https://pastebin.com/raw/T1x6YGbZ - Blacklisted BIOS versions
    inline std::vector<std::string> getBlacklistedBios() {
        return {
            "1111-2222-3333-4444-5555-6666-77",
            "23N3POYYY1",
            "3198-9985-5799-7712-2227-9299-33",
            "91o2Vzn",
            "BVE12AKCEN",
            "G8RSDBDNAE",
            "H8EDC23SF3",
            "nebwazhere-33461537510662145672765213630",
            "S215027X9C26307",
            "XT6AC1LSV7",
            "F2050F0",
            "A1B7R1ZEOG",
            ...
            "S215027X0421568",
            "GWSESTVRYZ",
            "8966-6471-0414-5159-3855-4982-24",
            "XAXOXCE8BK",
            "9O2WNWVP6M",
            "9QJZLY49",
            "2HZW8GMKZX",
    ...
    // https://pastebin.com/raw/VcuTddgf - Blacklisted Disk Serials
    inline std::vector<std::string> getBlacklistedDisks() {
        return {
            "0",
            "beaf1211",
            "beaf2081",
    ...
    // https://pastebin.com/raw/LSpkCfqc - Blacklisted GPUs
    inline std::vector<std::string> getBlacklistedGpus() {
        return {
            "29__HERE",
            "2RO_8UVU",
            "5KBK41_L",
    ...
    // https://pastebin.com/raw/tDXxxRUc - Blacklisted IPs
    inline std::vector<std::string> getBlacklistedIps() {
        return {
            "10.200.169.204",
            "104.198.155.173",
            "109.145.173.169",
